...
def chaoticdif(x,img):
   ...
   # pix1=[]
   # pix1 = [0 for i in range(262144)]
   di=[]
   di = [0 for i in range(0,262144)]
   #k=0;
   # for i1 in range(0,511):
   #  for j1 in range(0,511):
   #    pix1[k]=img[i1,j1]
   #    k=k+1
